      ...
      >
        <thead>
          <tr className="capitalize">
            <th className="p-3 border-b border-gray-300 text-teal-900 text-left">
              {"No."}
            </th>
            {column.map((col, i) => (
              <th
                ...
                key={i}
                className={`p-3 border-b border-gray-300 text-teal-900 text-left ${
          ...
          {slice.length > 0 ? (
            slice.map((item, i) => (
              <tr key={i} className="hover:bg-teal-50 transition">
                <td className="p-2 border-b border-gray-300 text-teal-800">
                  {page > 1 ? i + 1 + Number(props.rowPerPage) : i + 1}
                </td>
                {column.map((col, i2) => (
                  <td
                    className="p-2 border-b border-gray-300 text-teal-800"
                    key={i2}
                  >
                    {col.dataIndex ? (
            ...
            <tr className="p-1 text-teal-900 text-center">
