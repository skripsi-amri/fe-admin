...
function AppBar(props: {
  ...
  return (
    <div className="shadow bg-white shadow-teal-800 p-5 flex justify-between px-10 items-center">
      <div>
        <IconButton
      ...
      >
        <Iconify icon="mdi:face-man-profile" color="teal" other={"mr-2"} />
...
const PopUpMenu = (props: {
  ...
  return (
    <div
      ...
      } right-0 z-20 border w-56 py-2 mt-52 mr-16 overflow-hidden bg-white rounded-md shadow-sm shadow-teal-50`}
    >
      ...
      <div className="block px-4 py-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform hover:bg-teal-50">
        <p>My Profile</p>
      </div>
      ...
      <div
        ...
        className="block px-4 py-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform hover:bg-teal-50"
      >
        <p>Sign Out</p>
      </div>
    </div>
