...
export {
    LoginApi, LogoutApi, Me, editMerkBarang, editUkuranBarang, getAllMerkBarang, getAllUkuranBarang, getMerkBarang, getUkuranBarang, hapusMerkBarang, hapusUkuranBarang, tambahMerkBarang, tambahUkuranBarang, getAllBarang, editBarang, getBarang, hapusBarang, tambahBarang, hapusGudang, editGudang, getAllGudang, getGudang, tambahGudang
} 